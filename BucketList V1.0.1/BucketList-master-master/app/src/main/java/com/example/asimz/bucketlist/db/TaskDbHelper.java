...
public class TaskDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createTable1 = "CREATE TABLE " + TaskContract.PointsEntry.TABLE1 + " ( " +
                ...
                TaskContract.PointsEntry.COL_FIRST_NAME+ " TEXT NOT NULL, " +
                TaskContract.PointsEntry.COL_LAST_NAME+ " TEXT NOT NULL, " +
                TaskContract.PointsEntry.COL_POINTS_TP + " TEXT NOT NULL );";


        String createTable2 = "CREATE TABLE " + TaskContract.PointsDetails.tbName + " ( " +
                TaskContract.PointsDetails._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                TaskContract.PointsDetails.COL_POINTS + " TEXT NOT NULL , " +
                TaskContract.PointsDetails.COL_DATE + " TEXT NOT NULL);";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        onCreate(db);
        db.execSQL("DROP TABLE IF EXISTS " + TaskContract.PointsDetails.tbName);
        onCreate(db);
    ...
    public void StartValue(SQLiteDatabase db1){
        ...
        values.put(TaskContract.PointsEntry.COL_FIRST_NAME,"NAME");
        values.put(TaskContract.PointsEntry.COL_LAST_NAME,"LASTNAME");
